    ...
    return (
      <div className="content">
        ...
        <div style={{display: "flex"}}>
          <div style={{flex:"2", fontSize: "20px", textAlign: "Left", position: "-webkit-sticky", position: "sticky", alignSelf: "flex-start", top:"0px", padding:"20px"}}>
            <div><a href="#about">About</a></div>
            <div><a href="#experience">Experince</a></div>
            <div><a href="#sample-projects">Sample Projects</a></div>
